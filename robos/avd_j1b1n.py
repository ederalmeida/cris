...
def executa_robo():
    ...
    for NFe in NFes_a_escriturar:
        ...
        # Checando se a NFe possui um código fornecedor SAP válido. Se não tiver, já passa para a próxima NFe
        if NFe.id_sap == '#N/D':
            tabela_aux_log.append([NFe.chNFe, 'SEM CÓD SAP PARA FORNECEDOR', 'NÃO ESCRITURADA'])
            continue
        ...
        # Se a nota já existir, ignora e passa para a próxima
