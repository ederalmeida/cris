...
def inicializacao():
    ...
    coluna_esquerda = [[sg.Text('CRIS', size=(10,1), justification='center', font=("Helvetica", 50))],
                       [sg.Text('Central de Robôs para Interação com Sistemas', size=(20,2), justification='center', font=("Helvetica", 18))],
                       [sg.Text('')],
                       [sg.Frame('FINANÇAS/CONTÁBIL',
                        [[sg.Button('FBL3N', size=(10,1), key='-FBL3N-'),
                          sg.Button('FAGLL03', size=(10,1), key='-FAGLL03-'),
                          sg.Button('KOB1', size=(10,1), key='-KOB1-')]])],
                       [sg.Text('')],
                       [sg.Frame('AMBIENTAL',
                        [[sg.Button('IBAMA', size=(10,1), key='-IBAMA-'),
                          sg.Button('INEA/RJ', size=(10,1), key='-INEARJ-'),
                          sg.Button('CETESB/SP', size=(10,1), key='-CETESBSP-')],
