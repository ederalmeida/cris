...
def exibir():
    ...
    linha5_coluna1 = [[sg.Frame('Dados',
                       [[sg.Text('Relação de Contas de Fornecedores')],
    ...
    janela = sg.Window('Robô para Extrair Relatórios FBL1N', layout, default_element_size=(40, 1), element_justification='left', grab_anywhere=False) 
