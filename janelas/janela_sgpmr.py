...
def exibir():
    ...
    linha1 = [[sg.Text('Robô para cadastro no Sistema de Gerenciamento dos Planos de Melhorias e Reforços da ONS', size=(34, 3), justification='center', font=("Helvetica", 22))]]

    linha2 = [[sg.Text('_'  * 100, size=(72, 1))],      
              [sg.Text('Informações do Login', font=('Helvetica', 15), justification='left')]
             ]

    linha3 = [[sg.Text('Login', size=(10, 1)), sg.InputText('', key='-LOGIN-')],
              [sg.Text('Senha', size=(10, 1)), sg.InputText('', key='-SENHA-')]
             ]

    linha4 = [[sg.Text('_'  * 100, size=(72, 1))],
              [sg.Text('Dados', font=('Helvetica', 15), justification='left')]
             ]                 

    linha5 = [[sg.Text('Arquivo .csv contendo dados')],
    ...
    janela = sg.Window('Robô para Cadastrar dados SGPMR', layout, default_element_size=(40, 1), element_justification='left', grab_anywhere=False) 
